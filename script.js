      ...
      grid.insertAdjacentHTML("beforeend", `
        <article class="prod-card" tabindex="0" data-prod-id="${f.id}">
          ...
          <div class="prod-card__var">
            ...
            <div class="prod-card__var-track ${varTrackClass}" role="progressbar" aria-valuemin="0" aria-valuemax="150" aria-valuenow="${Math.round(Math.min(varPct,150))}" aria-valuetext="${varPctLabel}" aria-label="Atingimento da remuneração variável">
              <span style="width:${varFillPct}%"></span>
            </div>
          </div>
...
function ensureExecStyles(){
  ...
  s.textContent = `
    ...
    .exec-chart{background:#fff;border:1px solid var(--stroke);border-radius:14px;box-shadow:var(--shadow);padding:20px;margin-bottom:12px}
